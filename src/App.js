                  ...
                  <div key={i} className="mt-2 border-b pb-2">
                    ...
                    <div className="flex items-center gap-4">
                      <label className="flex items-center gap-2">
                        <input type="checkbox" checked={contact.isOwner} onChange={() => toggleOwner(index, i)} />
                        Owner
                      </label>
                      <label className="flex items-center gap-2">
                        <input type="checkbox" checked={contact.isDeceased} onChange={() => toggleDeceased(index, i)} />
                        Deceased
                      </label>
                    </div>
                  </div>
